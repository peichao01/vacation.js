...
exports.getPkg = function(pkgName){
	return pkgName ? availableFiles.pkg[pkgName] : availableFiles.pkg;
};
...
exports.setField = function(key, value){
	return availableFiles[key] = value;
};

exports.getField = function(key){
	return availableFiles[key];
};